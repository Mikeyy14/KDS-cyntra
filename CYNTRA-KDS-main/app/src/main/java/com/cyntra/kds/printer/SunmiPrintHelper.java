...
public class SunmiPrintHelper {
    ...
    /**
     *  deInit sunmi sunmiprint service
     */
     ...
     * like some devices do not have a printer but need to be connected to the cash drawer through a sunmiprint service
     */
    ...
    /**
     *  Due to the distance between the paper hatch and the sunmiprint head,
     ...
     *  In this example, the image will be printed because the sunmiprint text content is added
     */
...
//                sunmiPrinterService.printText("\n纵向排列\n", null);
     ...
     *  enter->sunmiprint->exit(get result) or
     *  enter->first sunmiprint->commit(get result)->twice sunmiprint->commit(get result)->exit(don't care
     *  result)
     */
    ...
    public void printExample(Context context){
        ...
        try {
            ...
            Bitmap bitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.burgerfront);
            sunmiPrinterService.printBitmap(bitmap, null);
