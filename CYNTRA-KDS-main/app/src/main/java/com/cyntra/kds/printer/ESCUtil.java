...
public class ESCUtil {
    ...
    public static final byte FF =  0x0C;// Carriage control (sunmiprint and return to the standard mode (in page mode))
    public static final byte CAN = 0x18;// Canceled (cancel sunmiprint data in page mode)
